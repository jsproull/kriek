...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FermConfiguration'
        db.create_table(u'ferm_fermconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fermconfs', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('mode', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'ferm', ['FermConfiguration'])

        # Adding M2M table for field probes on 'FermConfiguration'
        m2m_table_name = db.shorten_name(u'ferm_fermconfiguration_probes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fermconfiguration', models.ForeignKey(orm[u'ferm.fermconfiguration'], null=False)),
            ('probe', models.ForeignKey(orm[u'common.probe'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fermconfiguration_id', 'probe_id'])

        # Adding M2M table for field ssrs on 'FermConfiguration'
        m2m_table_name = db.shorten_name(u'ferm_fermconfiguration_ssrs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fermconfiguration', models.ForeignKey(orm[u'ferm.fermconfiguration'], null=False)),
            ('ssr', models.ForeignKey(orm[u'common.ssr'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fermconfiguration_id', 'ssr_id'])

        # Adding M2M table for field schedules on 'FermConfiguration'
        m2m_table_name = db.shorten_name(u'ferm_fermconfiguration_schedules')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fermconfiguration', models.ForeignKey(orm[u'ferm.fermconfiguration'], null=False)),
            ('schedule', models.ForeignKey(orm[u'common.schedule'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fermconfiguration_id', 'schedule_id'])


    def backwards(self, orm):
        # Deleting model 'FermConfiguration'
        db.delete_table(u'ferm_fermconfiguration')

        # Removing M2M table for field probes on 'FermConfiguration'
        db.delete_table(db.shorten_name(u'ferm_fermconfiguration_probes'))

        # Removing M2M table for field ssrs on 'FermConfiguration'
        db.delete_table(db.shorten_name(u'ferm_fermconfiguration_ssrs'))

        # Removing M2M table for field schedules on 'FermConfiguration'
        db.delete_table(db.shorten_name(u'ferm_fermconfiguration_schedules'))
