...
if __name__ == "__main__":
	...
	try:
		...
		for pk in raspbrew.ferm.ssr_controllers:
			try:
				raspbrew.ferm.ssr_controllers[pk].stop()
			except AttributeError:
				pass
				
			time.sleep(2)

		for pk in raspbrew.brew.ssr_controllers:
			try:
				raspbrew.brew.ssr_controllers[pk].stop()
			except AttributeError:
				pass
